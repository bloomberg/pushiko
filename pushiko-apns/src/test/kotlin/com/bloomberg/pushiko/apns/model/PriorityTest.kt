...
internal class PriorityTest {
    ...
    fun orderOfKeys() {
        ...
        assertTrue(sortedKeys.contentDeepEquals(keys),
            "ApnsPriority values should be listed in lexicographical order.")
    }

    @Test
    fun one() {
        assertEquals(1, Priority.PRIORITIZE_POWER.code)
    }

    @Test
    fun five() {
        assertEquals(5, Priority.CONSERVE_POWER.code)
    }

    @Test
    fun ten() {
        assertEquals(10, Priority.IMMEDIATE.code)
    }
}
